...
RaytracedObject::rayForObserver(glm::mat4 inverse_projection, glm::mat4 modelview, unsigned int imageSizeX, unsigned int imageSizeY, unsigned int x,
                                unsigned int y) {
    ...
    glm::vec4 origin = glm::vec4(
            glm::dot(origin0, glm::vec4(glm::column(inverse_projection, 0))),
            glm::dot(origin0, glm::vec4(glm::column(inverse_projection, 1))),
            glm::dot(origin0, glm::vec4(glm::column(inverse_projection, 2))),
            glm::dot(origin0, glm::vec4(glm::column(inverse_projection, 3)))
    );
    origin *= 1.0f/origin.w;

    glm::vec4 direction0 = glm::vec4(
            glm::dot(back, glm::vec4(glm::column(modelview, 0))),
            glm::dot(back, glm::vec4(glm::column(modelview, 1))),
            glm::dot(back, glm::vec4(glm::column(modelview, 2))),
            glm::dot(back, glm::vec4(glm::column(modelview, 3)))
    );
    ...
    glm::vec4 direction = glm::vec4(
            glm::dot(direction0, glm::vec4(glm::column(modelview, 0))),
            glm::dot(direction0, glm::vec4(glm::column(modelview, 1))),
            glm::dot(direction0, glm::vec4(glm::column(modelview, 2))),
            glm::dot(direction0, glm::vec4(glm::column(modelview, 3)))
    );
    direction.w = 0.0f;
