...
bool APRConverterBatch<ImageType>::get_apr_method_from_file(APR<ImageType> &aAPR, const TiffUtils::TiffInfo &aTiffFile) {
 ...
 */
template<typename ImageType> template<typename T>
bool APRConverterBatch<ImageType>::get_apr_method(APR<ImageType> &aAPR, PixelData<T>& input_image) {
...
template<typename ImageType>
void APRConverterBatch<ImageType>::get_local_particle_cell_set(PixelData<ImageType> &grad_temp, PixelData<float> &local_scale_temp, PixelData<float> &local_scale_temp2) {
    //
...
template<typename ImageType>
void APRConverterBatch<ImageType>::get_gradient(PixelData<ImageType> &image_temp, PixelData<ImageType> &grad_temp, PixelData<float> &local_scale_temp, PixelData<float> &local_scale_temp2, float bspline_offset, const APRParameters &par) {
    //  Bevan Cheeseman 2018
...
template<typename ImageType>
void APRConverterBatch<ImageType>::get_local_intensity_scale(PixelData<float> &local_scale_temp, PixelData<float> &local_scale_temp2, const APRParameters &par) {
    //
...
template<typename ImageType> template<typename T>
void APRConverterBatch<ImageType>::init_apr(APR<ImageType>& aAPR,PixelData<T>& input_image){
    //
...
template<typename ImageType> template<typename T>
void APRConverterBatch<ImageType>::auto_parameters(const PixelData<T>& input_img){
    //
