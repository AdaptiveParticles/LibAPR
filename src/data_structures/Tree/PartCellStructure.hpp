                    ...
                    for(y_ = 0;y_ < y_num;y_++){
                        ...
                        if((status> 0) & (status < 8)){
                            ...
                            if(prev_ind == 1){
                                //gap node
                                //set type
                                pc_data.data[i][offset_pc_data][curr_index-1] = 1;
                            ...
                            //set type
                            pc_data.data[i][offset_pc_data][curr_index-1] = 0;
...
#pragma omp parallel for default(shared) private(z_,x_,j_,node_val,y_parent,j_parent,j_neigh,y_neigh,y_coord) if(z_num*x_num > 100)
                        ...
                        for(j_ = 1;j_ < j_num;j_++){
                            ...
                            if (node_val&1){
                                ...
                                if(y_coord == y_neigh){
                                    ...
                                    pc_data.data[i][offset_pc_data][j_] |= (1 << XP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= (j_neigh << XM_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= (1 << XM_DEPTH_SHIFT);
                                    
                                } else {
                                    pc_data.data[i][offset_pc_data][j_] |= (j_parent << XP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= (0 << XP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= (j_ << XM_INDEX_SHIFT);
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= (0 << XM_DEPTH_SHIFT);
                                }
                ...
                const unsigned int x_num_child = pc_data.x_num[i];
...
#pragma omp parallel for default(shared) private(z_,x_,j_,node_val,y_parent,j_parent,j_neigh,y_neigh,y_coord,y_child,j_child) if(z_num*x_num > 100)
                        ...
                        for(j_ = 1;j_ < j_num;j_++){
                            ...
                            if (node_val&1){
                                ...
                                if(y_coord == y_neigh){
                                    ...
                                    pc_data.data[i][offset_pc_data][j_] |= (2 << XP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= (j_ << XM_INDEX_SHIFT);
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= (2 << XM_DEPTH_SHIFT);
                                }
                ...
                const unsigned int x_num_child = pc_data.x_num[i];
                const unsigned int z_num_child = pc_data.z_num[i];
                        ...
                        for(j_ = 1;j_ < j_num;j_++){
                            ...
                            if (node_val&1){
                                ...
                                if(y_coord == y_neigh){
                                    ...
                                    pc_data.data[i][offset_pc_data][j_] |= ((uint64_t)1 << ZP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= (j_neigh << ZM_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= ((uint64_t)1 << ZM_DEPTH_SHIFT);
                                    
                                } else {
                                    pc_data.data[i][offset_pc_data][j_] |= (j_parent << ZP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= ((uint64_t)0 << ZP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= (j_ << ZM_INDEX_SHIFT);
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= ((uint64_t)2 << ZM_DEPTH_SHIFT);
                                }
                    ...
                    for(x_ = 0;x_ < (x_num);x_++){
                        ...
                        for(j_ = 1;j_ < j_num;j_++){
                            ...
                            if (node_val&1){
                                ...
                                if(y_coord == y_neigh){
                                    pc_data.data[i][offset_pc_data][j_] |= (j_neigh << ZP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= (1 << ZP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= (j_ << ZM_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= (1 << ZM_DEPTH_SHIFT);
                                } else  {
                                    pc_data.data[i][offset_pc_data][j_] |= (j_child << ZP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= (2 << ZP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= (j_ << ZM_INDEX_SHIFT);
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= (2 << ZM_DEPTH_SHIFT);
                                }
                        ...
                        for(j_ = 1;j_ < j_num;j_++){
                            ...
                            if (node_val&1){
                                ...
                                if(y_coord == y_neigh){
                                    ...
                                    pc_data.data[i][offset_pc_data][j_] |= ((uint64_t) 1 << ZP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= ((uint64_t) j_  << ZM_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data_neigh][j_neigh] |= ((uint64_t) 1  << ZM_DEPTH_SHIFT);
                                } else if (y_coord == y_child/2) {
                                    pc_data.data[i][offset_pc_data][j_] |= (j_child << ZP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= ((uint64_t) 2 << ZP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= ((uint64_t) j_ << ZM_INDEX_SHIFT);
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= ((uint64_t) 2  << ZM_DEPTH_SHIFT);
                                } else {
                                    pc_data.data[i][offset_pc_data][j_] |= (j_parent << ZP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= ( (uint64_t) 0  << ZP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= ((uint64_t) j_ << ZM_INDEX_SHIFT);
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= ((uint64_t) 0  << ZM_DEPTH_SHIFT);
                                }
                        ...
                        for(j_ = 1;j_ < (j_num);j_++){
                            ...
                            if (node_val&1){
                                ...
                                if(y_coord/2 == y_parent){
                                    ...
                                    pc_data.data[i][offset_pc_data][j_] |= (0 << YP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= (j_ << YM_INDEX_SHIFT);
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= (0 << YM_DEPTH_SHIFT);
                                }
                    ...
                    for(x_ = 0;x_ < (x_num);x_++){
                        ...
                        for(j_ = 1;j_ < j_num;j_++){
                            ...
                            if (node_val&1){
                                ...
                                if(y_coord/2 == y_child){
                                    
                                    pc_data.data[i][offset_pc_data][j_] |= (j_child << YP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= (2 << YP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= (j_ << YM_INDEX_SHIFT);
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= (0 << YM_DEPTH_SHIFT);
                                }
                    ...
                    for(x_ = 0;x_ < (x_num);x_++){
                        ...
                        for(j_ = 1;j_ < j_num;j_++){
                            ...
                            if (node_val&1){
                                ...
                                if (y_coord == y_child/2) {
                                    pc_data.data[i][offset_pc_data][j_] |= (j_child << YP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= ((uint64_t) 2 << YP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= ((uint64_t) j_ << YM_INDEX_SHIFT);
                                    pc_data.data[i+1][offset_pc_data_child][j_child] |= ((uint64_t) 0  << YM_DEPTH_SHIFT);
                                } else {
                                    pc_data.data[i][offset_pc_data][j_] |= (j_parent << YP_INDEX_SHIFT);
                                    pc_data.data[i][offset_pc_data][j_] |= ( (uint64_t) 0  << YP_DEPTH_SHIFT);
                                    //symmetric
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= ((uint64_t) j_ << YM_INDEX_SHIFT);
                                    pc_data.data[i-1][offset_pc_data_parent][j_parent] |= ((uint64_t) 2  << YM_DEPTH_SHIFT);
                                }
