...
//#TODO: I think this is largely obsolete now, and has lost support in the new reader, and i'm not sure if I will impliment it
// we are better going the route of using particle visualization in Python or Java using Scenery.
////
...
//
//The file can also be read into Matlab, using Matlab_helpers/load_apr_full.m
//
//Usage:
//
