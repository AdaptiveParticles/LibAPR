...
int main(int argc, char **argv) {
    ...
    uint64_t node_val; // node variable encoding neighbour and cell information
    ...
    PartCellNeigh<uint64_t> neigh_keys; // data structure for holding particle or cell neighbours
