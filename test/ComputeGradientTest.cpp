...
namespace {
   ...
   */
    ...
    TEST(ComputeThreshold, FULL_GRADIENT_TEST) {
        ...
        PixelData<ImageType> input_image = getRandInitializedMesh<ImageType>(310, 330, 21, 25);
    ...
    TEST(ComputeThreshold, FULL_PIPELINE_TEST) {
        ...
        // Generate random mesh
        using ImageType = float;
        PixelData<ImageType> input_image = getRandInitializedMesh<ImageType>(110, 130, 32, 25);
        ...
        // TODO: Currently number of allowed differences is big enough to pass this test - in the end should be handled differently
        EXPECT_TRUE(compareMeshes(local_scale_temp, local_scale_temp_GPU, 0.01, 255) < 300); }
