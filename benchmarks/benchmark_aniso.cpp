//
// Created by cheesema on 08.10.17.
//

#include "benchmark_aniso.hpp"
            ...
            for (int p = 0; p < N_par2; p++) {
                ...
                for (int j = 0; j < N_par1; j++) {
                    ...
                    for (int i = 0; i < bs.N_repeats; i++) {
                        ...
                        syn_image_loc.sampling_properties.sampling_delta[2] = dz;

                        syn_image_loc.PSF_properties.real_sigmas[0] = psfx*dx;
                        syn_image_loc.PSF_properties.real_sigmas[1] = psfx*dx;
                        syn_image_loc.PSF_properties.real_sigmas[2] = psfz*dx;
